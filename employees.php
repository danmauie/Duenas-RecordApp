...
<?php 
    ...
    if( strlen($search)>0){
        //Create Query
        $query = 'SELECT employee.id, employee.lastname, employee.firstname, employee.address, office.name as office_name FROM employee, office WHERE employee.office_id = office.id AND employee.lastname = "'. $search .'" ORDER BY employee.lastname LIMIT ' . $page_first_result .',' . $results_per_page;
        //Get Result
        $result = mysqli_query($conn, $query); 
    }else{
        //Create Query
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="col-md-12">
                                <a href="employees-add.php">
                                    <button class="btn btn-info btn-fill pull-right">Add New Employee</button>
                                </a>
                            </div>
                            <div class="header">
                                <h4 class="title">Employees</h4>
                                <p class="category">Here is the list of all employees recorded in the database.</p>
                            </div>
                ...
                <?php
                    for($page=1; $page<=$number_of_page; $page++){
                        echo '<a href=employees.php?page='.$page.'>' . $page . '</a>';
                    } 
                ?>
            </div>
        </div>
