...
<?php 
 ...
 if(isset($_POST['submit'])){
    ...
    //create query
    $query = "INSERT INTO transaction(employee_id, office_id, datelog, action, remarks, documentcode) VALUES ('$employeeid', '$officeid', NOW(), '$action', '$remarks', '$documentcode')";
    //execute query
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add New Transaction</h4>
                            </div>
                            <div class="content">
